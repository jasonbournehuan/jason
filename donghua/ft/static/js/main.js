...
var gameCode = "xyft", animateSoundType = !0, parLiveResult, openDateTime, openNum, preIssue, windflameTimer,
    runningSoundTimer, carTimer, posTimer, carpositionoffset = [0, 9, 25, 40, 53, 67, 78, 101, 122, 139], lightsSound = $("#lights")[0],
    carStartSound = $("#running")[0], carRunningSound = $("#running")[0], finishSound = $("#finish")[0],
    animate = {
        ...
        lightStart: function () {
            ...
            runningSoundTimer = setTimeout(function () { animate.carRunningSoundStart() }, 11e3)
        },
        otherStart: function () {
            function a() {
            ...
            $(".wheela").css("display", "block");
            $(".wheelb").css("display", "block");
            var t = $("#roadstart");
