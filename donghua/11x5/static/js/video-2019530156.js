...
pubmethod.creatHeadD = {
    ...
    shiyi5: function (e, t) {
        ...
        console.log(i),
        t.flag)
            $(".nameLogo").find("img").attr("src", "logo/" + game_id + ".png"),
            k3v.startVideo(o, t),
    ...
    jisuft: function (e, t) {
        ...
        $("#status").css("background-image", "../images/logo_" + game_id + ".png"),
        $(".logo").find("img").attr("src", "images/logo_" + game_id + ".png");
        for (var r = pubmethod.tools.cutTime(o.drawTime, o.serverTime), s = o.preDrawCode.split(","), i = [], u = 0, n = s.length; u < n; u++)
            "0" == s[u].substr(0, 1) ? i.push(1 * s[u].substr(1, 1)) : i.push(1 * s[u]);
        if (r = r < 0 ? 1 : r,
        o.cutime = r,
