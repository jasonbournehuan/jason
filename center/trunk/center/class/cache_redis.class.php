 ...
 *
 */
class cache_redis extends base_model{
    private $redis;
    ...
    {
		parent::__construct();
		$this->config = $this->conf['cache']['redis'];
        ...
        $this->expireTime    =    $_SERVER['time'] + $this->attr['timeout'];
    }
    ...
    public static function getInstance($config, $attr = array())
    {
        ...
        elseif( $_SERVER['time'] > static::$_instance[$k]->expireTime)
        {
     ...
     * @param unknown $value
     */
    public function kSet($key,$value)
    {
