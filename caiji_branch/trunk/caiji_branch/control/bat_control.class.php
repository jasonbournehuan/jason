...
class bat_control extends common_control {
    ...
    public function make_bat($name){
        ...
        echo  第%n%次 >>  D:/phpStudy/PHPTutorial/WWW/caipiaocj/script/logo/'.$name.'.txt
        php.exe '.BBS_PATH.'collection.php -0 '.$name.' >>  D:/phpStudy/PHPTutorial/WWW/caipiaocj/script/logo/'.$name.'.txt
        echo.  >>  D:/phpStudy/PHPTutorial/WWW/caipiaocj/script/logo/'.$name.'.txt
