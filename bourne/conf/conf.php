...
return array (
	...
	'db' => array (
		...
		'mysqli' => array (
			'master' => array (
                 'host' => '127.0.0.1',
                //	'host' => '10.88.216.92',//本地测试数据库
                //   'host' => '3.114.141.79:3308', //center线上
					'user' => 'root',
                //	'user' => 'center',
					'password' => 'root',
					'name' => 'center',
    ...
    'platform' => array(
        ...
        "13" => array(
            "url" => "https://gi.mingbo8888.com/doBusiness.do?",
            "url1" => "https://gci.mingbo8888.com/forwardGame.do?",
            "agent" => "FN4_AGIN",
            "md5Key" => "XFUjmCeTzWtP",
            "desKey" => "rHnhKJFC",
        ),
	...
	'decrypt_url' => 'www.web.com/goto_game.htm',
