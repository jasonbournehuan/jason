...
class core {
	...
	*/
	...
	public static function autoload_handle($classname) {
		$libclasses = ' check, log, misc, form, utf8, image, template, db_mysql, db_mysqli, db_mongodb, db_pdo, db_file, db_ttserver, cache_apc, cache_ea, cache_memcache, cache_redis, cache_xcache, json_data, ';
