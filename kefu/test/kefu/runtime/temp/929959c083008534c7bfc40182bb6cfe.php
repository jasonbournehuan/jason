<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\PHPTutorial\WWW\kefu\public/../application/index\view\index\chat.html";i:1554196833;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin" style="width: 100%;margin: 0 auto;">
    <div class="layui-header" style="background: #01AAED;">
    ...
    <div class="layui-body whisper-chat-area">
        <div class="chat-left">
            ...
            <div class="msg-send">
                ...
                <div class="send-area">
					<div style="float:left;font-size: 12px;padding: 0 0 0 10px;" class="layui-form"><input type="checkbox" name="switch" lay-skin="switch" lay-text="CTRL + 回车发送|回车发送" lay-filter="kj_post" value="1" checked=""></div>
