<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"D:\phpStudy\PHPTutorial\WWW\zj-whisper_pay\public/../application/admin\view\system\wordslog.html";i:1548385890;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function delword(id) {
        ...
        $.getJSON('/admin/system/deleteWords', {id: id}, function (res) {
            if(1 == res.code) {
                layer.msg(res.msg);
                initTable();
            }
