<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpStudy\PHPTutorial\WWW\kefu\public/../application/admin\view\index.html";i:1554382431;s:75:"D:\phpStudy\PHPTutorial\WWW\kefu\public/../application/admin\view\menu.html";i:1551876628;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
                    ...
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear">
                                ...
                                <span class="text-muted text-xs block"><?php echo $admin_username; ?><b class="caret"></b></span>
                            </span>
                        </a>
    ...
    <ul class="nav nav-second-level">
        ...
        <li>
            <a class="J_menuItem" href="<?php echo url('users/praise'); ?>">单个客服分析</a>
        </li>
        <li>
            <a class="J_menuItem" href="<?php echo url('users/praiseAll'); ?>">总体客服分析</a>
        </li>
    </ul>
</li>
<?php if($uid == 1): ?>
<li class="menu">
    ...
    <ul class="nav nav-second-level">
        <li>
            <a class="J_menuItem" href="<?php echo url('groups/index'); ?>">网站列表</a>
        </li>
        <li>
            <a class="J_menuItem" href="<?php echo url('groups/addGroup'); ?>">添加网站</a>
        </li>
    </ul>
</li>
...
<li class="menu">
    ...
    <ul class="nav nav-second-level">
        <li>
            <a class="J_menuItem" href="<?php echo url('secret/edit'); ?>">第三方登陆</a>
        </li>
        <li>
        ...
        <li>
            <a class="J_menuItem" href="<?php echo url('notice/index'); ?>">系统公告列表</a>
        </li>
    </ul>
</li>
...
<li class="menu">
    ...
    <ul class="nav nav-second-level">
        <li>
            <a class="J_menuItem" href="<?php echo url('question/index'); ?>">常见问题列表</a>
        </li>
    </ul>
</li>
...
<li class="menu">
    <a href="#">
        ...
        <span class="nav-label">历史会话&留言</span>
        <span class="fa arrow"></span>
    </a>
    <ul class="nav nav-second-level">
        <li>
        ...
        <li>
            <a class="J_menuItem" href="<?php echo url('system/leaveMsgLog'); ?>">留言列表</a>
        </li>
    </ul>
</li>
                <!-- 菜单结束 -->
