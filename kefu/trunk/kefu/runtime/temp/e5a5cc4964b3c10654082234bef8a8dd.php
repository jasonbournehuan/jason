<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\PHPTutorial\WWW\kefu\public/../application/admin\view\users\adduser.html";i:1554385154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t layui-form" id="commentForm" method="post" action="<?php echo url('users/adduser'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="password" type="password" class="form-control" name="user_pwd" required="" aria-required="true">
                            </div>
                        </div>
                        <?php if($is_super): ?>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-4">
                                <a href="<?php echo url('users/index'); ?>" class="btn btn-outline btn-primary">&lt;&lt;返回列表</a>
